...
{
    /// <inheritdoc />
    public partial class ahi3 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinimunTotalBillAccept = table.Column<double>(type: "float", nullable: true),
                    IsPercentValue = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VoucherShopId = table.Column<int>(type: "int", nullable: true),
